...
//////////////////////////////////////////////////Code begins
        SharedPreferences spref = getSharedPreferences(Utils.MyPref, Context.MODE_PRIVATE);
         name = spref.getString(Utils.Name, null); // getting String
         id = spref.getString(Utils.Phone, null);
         email = spref.getString(Utils.Email, null);
        college = spref.getString(Utils.College, null);
        dpres = spref.getString(Utils.displaypic, null);
        dets = spref.getString(Utils.Extras, null);
